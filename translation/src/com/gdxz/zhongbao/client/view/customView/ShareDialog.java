...
public class ShareDialog
{
	...
	private int[] image = {R.drawable.share_sina, R.drawable.share_wechat,
			R.drawable.share_wechat_moments, R.drawable.share_qq};
	...
	public ShareDialog(Context context)
	{
		...
		saImageItems = new SimpleAdapter(context, shareList, R.layout.share_item, new String[]{
				"ItemImage", "ItemText"}, new int[]{R.id.imageView1, R.id.textView1});
