 ...
 * @author chenantao
 */
public class HomeTotalRankingFragment extends LazyFragment
{
	// 标记当前在第几页
...
//		Log.e("TAG", "total oncreate");
	                         ...
	                         Bundle savedInstanceState)
	{
		...
		View wrapper = inflater.inflate(R.layout.home_question_ui, null);
...
//		 监听列表被刷新时事件.
	...
	public void lazyLoad()
	{
		...
		{
			DialogUtils.showProgressDialog("总排行榜", "数据玩命加载中", getActivity());
			questionService.loadQuestionData(handler, pageNow + "",
					HomeActivity.TOTAL_RANKING + "", HomeActivity.REFRESH_DATA,
					mPullRefreshListView);
		} else
		{
