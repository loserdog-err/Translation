...
public class SpUtils
{
	...
	{
		SharedPreferences.Editor editor = context.getSharedPreferences(DEFAULT_FILE_NAME, context.MODE_PRIVATE).edit();
		editor.putString(key, value);
		editor.commit();
	}
	 ...
	 * @param set
	 */
	public static void setStringSetProperty(Context context,String key, Set<String> set, String fileName)
	{
		SharedPreferences.Editor editor = context.getSharedPreferences(fileName, context.MODE_PRIVATE).edit();
		editor.putStringSet(key, set);
		editor.commit();
